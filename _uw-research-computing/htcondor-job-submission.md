...
1. First, create the executable script you would like HTCondor to run.  For our example, copy the text below and paste it into a file called `hello-world.sh` (we recommend using a command line text editor) in your home directory.
